...
<h1>Canvas</h1>
<small>`mint.render.luxe.Canvas`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(\_render:[mint.render.luxe.LuxeMintRender](../../../../api/mint/render/luxe/LuxeMintRender.html)<span></span>, \_control:[mint.Canvas](../../../../api/mint/Canvas.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
