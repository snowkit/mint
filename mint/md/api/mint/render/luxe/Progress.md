...
<h1>Progress</h1>
<small>`mint.render.luxe.Progress`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">bar : [phoenix.geometry.QuadGeometry](#)</code><br/></span>
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="color_bar"><a class="lift" href="#color_bar">color\_bar</a></a><div class="clear"></div>
                <code class="signature apipage">color\_bar : [luxe.Color](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="progress"><a class="lift" href="#progress">progress</a></a><div class="clear"></div>
                <code class="signature apipage">progress : [mint.Progress](../../../../api/mint/Progress.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(\_render:[mint.render.luxe.LuxeMintRender](../../../../api/mint/render/luxe/LuxeMintRender.html)<span></span>, \_control:[mint.Progress](../../../../api/mint/Progress.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
