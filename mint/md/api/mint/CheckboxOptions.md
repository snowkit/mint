...
<h1>CheckboxOptions</h1>
<small>`mint.CheckboxOptions`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">Whether or not the control is visible at creation</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">state : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The initial state of the checkbox</span><br/><span class="member apipage">
            ...
            which can be strong typed on the receiving end.</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">onchange : [Null](http://api.haxe.org/Null.html)&lt;[](#)&gt;</code><br/></span>
            <span class="small_desc_flat">A signal handler for when the checkbox state changes.
            The handler is `function(_new_state:Bool, _prev_state:Bool)`</span><br/><span class="member apipage">
