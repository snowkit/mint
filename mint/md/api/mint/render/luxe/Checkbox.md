...
<h1>Checkbox</h1>
<small>`mint.render.luxe.Checkbox`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="checkbox"><a class="lift" href="#checkbox">checkbox</a></a><div class="clear"></div>
                <code class="signature apipage">checkbox : [mint.Checkbox](../../../../api/mint/Checkbox.html)</code><br/></span>
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="color_node"><a class="lift" href="#color_node">color\_node</a></a><div class="clear"></div>
                <code class="signature apipage">color\_node : [luxe.Color](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="color_node_hover"><a class="lift" href="#color_node_hover">color\_node\_hover</a></a><div class="clear"></div>
                <code class="signature apipage">color\_node\_hover : [luxe.Color](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="node"><a class="lift" href="#node">node</a></a><div class="clear"></div>
                <code class="signature apipage">node : [luxe.Sprite](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="node_off"><a class="lift" href="#node_off">node\_off</a></a><div class="clear"></div>
                <code class="signature apipage">node\_off : [luxe.Sprite](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(\_render:[mint.render.luxe.LuxeMintRender](../../../../api/mint/render/luxe/LuxeMintRender.html)<span></span>, \_control:[mint.Checkbox](../../../../api/mint/Checkbox.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
