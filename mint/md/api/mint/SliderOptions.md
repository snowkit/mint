...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">Whether or not the control responds to key input</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">invert : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Inverts the sliders default direction. If true, horizontal slider goes from right to left and vertical slider from top to bottom. default: false</span><br/><span class="member apipage">
