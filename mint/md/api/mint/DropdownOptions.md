...
<h1>DropdownOptions</h1>
<small>`mint.DropdownOptions`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The text size of the text</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The text to display on the label</span><br/><span class="member apipage">
            ...
            which can be strong typed on the receiving end.</span><br/><span class="member apipage">
                <a name="onclick"><a class="lift" href="#onclick">onclick</a></a><div class="clear"></div>
                <code class="signature apipage">onclick : [Null](http://api.haxe.org/Null.html)&lt;[mint.MouseSignal](../../api/mint/MouseSignal.html)&gt;</code><br/></span>
            <span class="small_desc_flat">An optional mouseup handler for convenience</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Whether or not to wrap the text by the bounds for the rendering to apply</span><br/><span class="member apipage">
                <a name="align_vertical"><a class="lift" href="#align_vertical">align\_vertical</a></a><div class="clear"></div>
                <code class="signature apipage">align\_vertical : [Null](http://api.haxe.org/Null.html)&lt;[mint.types.TextAlign](../../api/mint/types/TextAlign.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The text alignment on the vertical axis, relative to the bounds</span><br/><span class="member apipage">
                <a name="align"><a class="lift" href="#align">align</a></a><div class="clear"></div>
                <code class="signature apipage">align : [Null](http://api.haxe.org/Null.html)&lt;[mint.types.TextAlign](../../api/mint/types/TextAlign.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The text alignment on the horizontal axis, relative to the bounds</span><br/>
