...
<h1>KeyEvent</h1>
<small>`mint.types.KeyEvent`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The time in seconds when this key event occurred, useful for deltas</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The state this event is in</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">mod : [mint.types.ModState](../../../api/mint/types/ModState.html)</code><br/></span>
            <span class="small_desc_flat">The modifier state</span><br/><span class="member apipage">
                <a name="keycode"><a class="lift" href="#keycode">keycode</a></a><div class="clear"></div>
                <code class="signature apipage">keycode : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">The raw keycode of the event</span><br/><span class="member apipage">
                <a name="key"><a class="lift" href="#key">key</a></a><div class="clear"></div>
                <code class="signature apipage">key : [mint.types.KeyCode](../../../api/mint/types/KeyCode.html)</code><br/></span>
            <span class="small_desc_flat">The typed mint key for the event</span><br/><span class="member apipage">
