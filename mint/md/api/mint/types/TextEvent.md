...
<h1>TextEvent</h1>
<small>`mint.types.TextEvent`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">type : [mint.types.TextEventType](../../../api/mint/types/TextEventType.html)</code><br/></span>
            <span class="small_desc_flat">The type of text event</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The text that this event has generated</span><br/><span class="member apipage">
                <a name="start"><a class="lift" href="#start">start</a></a><div class="clear"></div>
                <code class="signature apipage">start : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">The start position, if the `type` is `edit`</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The length position, if the `type` is `edit`</span><br/><span class="member apipage">
