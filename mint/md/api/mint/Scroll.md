...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="child_bounds"><a class="lift" href="#child_bounds">child\_bounds</a></a><div class="clear"></div>
                <code class="signature apipage">child\_bounds : [mint.ChildBounds](../../api/mint/ChildBounds.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="container"><a class="lift" href="#container">container</a></a><div class="clear"></div>
                <code class="signature apipage">container : [mint.Control](../../api/mint/Control.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="onhandlevis"><a class="lift" href="#onhandlevis">onhandlevis</a></a><div class="clear"></div>
                <code class="signature apipage">onhandlevis : [mint.core.Signal](../../api/mint/core/Signal.html)&lt;[](#)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="scrollh"><a class="lift" href="#scrollh">scrollh</a></a><div class="clear"></div>
                <code class="signature apipage">scrollh : [mint.Control](../../api/mint/Control.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="scrollv"><a class="lift" href="#scrollv">scrollv</a></a><div class="clear"></div>
                <code class="signature apipage">scrollv : [mint.Control](../../api/mint/Control.html)</code><br/></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_options:[mint.ScrollOptions](../../api/mint/ScrollOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="refresh_scroll"><a class="lift" href="#refresh_scroll">refresh\_scroll</a></a><div class="clear"></div>
            <code class="signature apipage">refresh\_scroll() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            <a name="set_scroll_percent"><a class="lift" href="#set_scroll_percent">set\_scroll\_percent</a></a><div class="clear"></div>
            <code class="signature apipage">set\_scroll\_percent(\_horizontal:[Float](http://api.haxe.org/Float.html)<span></span>, \_vertical:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="update_container"><a class="lift" href="#update_container">update\_container</a></a><div class="clear"></div>
            <code class="signature apipage">update\_container() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
