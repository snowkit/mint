...
<small>`mint.ProgressOptions`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">Whether or not the control emits render signals from the canvas render call</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">progress : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The default progress</span><br/><span class="member apipage">
