...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="dragged"><a class="lift" href="#dragged">dragged</a></a><div class="clear"></div>
                <code class="signature apipage">dragged : [mint.Control](../../api/mint/Control.html)</code><br/></span>
            <span class="small_desc_flat">The current dragged control, null if none</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The current focused control, null if none</span><br/><span class="member apipage">
                <a name="modal"><a class="lift" href="#modal">modal</a></a><div class="clear"></div>
                <code class="signature apipage">modal : [mint.Control](../../api/mint/Control.html)</code><br/></span>
            <span class="small_desc_flat">The current modal control, null if none</span><br/>
...
<span class="method apipage">
            <a name="reset_focus"><a class="lift" href="#reset_focus">reset\_focus</a></a><div class="clear"></div>
            <code class="signature apipage">reset\_focus(\_control:[mint.Control](../../api/mint/Control.html)<span></span>, e:[mint.types.MouseEvent](../../api/mint/types/MouseEvent.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Reset the focus to nothing, if given a control will tell
            that control of itself losing focus</span>
