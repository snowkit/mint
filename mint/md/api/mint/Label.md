...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">Emitted whenever text is changed.
            `function(text:String)`</span><br/>
...
<h3>Properties</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The text displayed by the label</span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_options:[mint.LabelOptions](../../api/mint/LabelOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
