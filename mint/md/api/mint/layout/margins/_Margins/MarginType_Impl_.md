...
<h1>MarginType_Impl_</h1>
<small>`mint.layout.margins._Margins.MarginType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">fixed : [mint.layout.margins.MarginType](../../../../../api/mint/layout/margins/MarginType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="percent"><a class="lift" href="#percent">percent</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">percent : [mint.layout.margins.MarginType](../../../../../api/mint/layout/margins/MarginType.html)</code><br/></span>
