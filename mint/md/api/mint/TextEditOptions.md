...
<h1>TextEditOptions</h1>
<small>`mint.TextEditOptions`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The text size of the text for the rendering to use</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The default text value</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The control height</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">filter : [Null](http://api.haxe.org/Null.html)&lt;[](#)&gt;</code><br/></span>
            <span class="small_desc_flat">A filter function to call when text is entered.
            It is: `filter(new_character, new_text, old_text):Bool`.
            Returning false will reject the character.</span><br/><span class="member apipage">
                <a name="display_char"><a class="lift" href="#display_char">display\_char</a></a><div class="clear"></div>
                <code class="signature apipage">display\_char : [Null](http://api.haxe.org/Null.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat">An override display character (like * for a password entry)</span><br/><span class="member apipage">
