...
<h1>Utf8_Impl_</h1>
<small>`mint.core.unifill._Utf8.Utf8_Impl_`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">charAt(this:[mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)<span></span>, index:[Int](http://api.haxe.org/Int.html)<span></span>) : [mint.core.unifill.Utf8](../../../../../api/mint/core/unifill/Utf8.html)</code><br/><span class="small_desc_flat">Returns the character as a String at position `index` of
       `this`.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">codePointAt(this:[mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)<span></span>, index:[Int](http://api.haxe.org/Int.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat">Returns the Unicode code point at position `index` of
       `this`.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">codeUnitAt(this:[mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)<span></span>, index:[Int](http://api.haxe.org/Int.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat">Returns the UTF-8 code unit at position `index` of `this`.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">substr(this:[mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)<span></span>, index:[Int](http://api.haxe.org/Int.html)<span></span>, len:[Int](http://api.haxe.org/Int.html)<span></span>) : [mint.core.unifill.Utf8](../../../../../api/mint/core/unifill/Utf8.html)</code><br/><span class="small_desc_flat">Returns `len` code units of `this`, starting at position pos.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">toBytes(this:[mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)<span></span>) : [haxe.io.Bytes](http://api.haxe.org/haxe/io/Bytes.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">toString(this:[mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)<span></span>) : [String](http://api.haxe.org/String.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="validate"><a class="lift" href="#validate">validate</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">validate(this:[mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Validates `this` Utf8 string.
