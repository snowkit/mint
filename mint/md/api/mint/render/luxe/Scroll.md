...
<h1>Scroll</h1>
<small>`mint.render.luxe.Scroll`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="color_handles"><a class="lift" href="#color_handles">color\_handles</a></a><div class="clear"></div>
                <code class="signature apipage">color\_handles : [luxe.Color](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="scroll"><a class="lift" href="#scroll">scroll</a></a><div class="clear"></div>
                <code class="signature apipage">scroll : [mint.Scroll](../../../../api/mint/Scroll.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="scrollh"><a class="lift" href="#scrollh">scrollh</a></a><div class="clear"></div>
                <code class="signature apipage">scrollh : [luxe.Sprite](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="scrollv"><a class="lift" href="#scrollv">scrollv</a></a><div class="clear"></div>
                <code class="signature apipage">scrollv : [luxe.Sprite](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(\_render:[mint.render.luxe.LuxeMintRender](../../../../api/mint/render/luxe/LuxeMintRender.html)<span></span>, \_control:[mint.Scroll](../../../../api/mint/Scroll.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
