...
<h1>CodePointIter</h1>
<small>`mint.core.unifill.CodePointIter`</small>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(s:[String](http://api.haxe.org/String.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="next"><a class="lift" href="#next">next</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">next() : [mint.core.unifill.CodePoint](../../../../api/mint/core/unifill/CodePoint.html)</code><br/><span class="small_desc_flat"></span>
