...
<h1>UtfTools</h1>
<small>`mint.core.unifill.UtfTools`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="compare"><a class="lift" href="#compare">compare</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">compare&lt;T&gt;(a:[compare.T](#)<span></span>, b:[compare.T](#)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>
