...
<h1>Utf16</h1>
<small>`mint.core.unifill.Utf16`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">charAt(index:[Int](http://api.haxe.org/Int.html)<span></span>) : [mint.core.unifill.Utf16](../../../../api/mint/core/unifill/Utf16.html)</code><br/><span class="small_desc_flat">Returns the character as a String at position `index` of
       `this`.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">codeUnitAt(index:[Int](http://api.haxe.org/Int.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat">Returns the UTF-16 code unit at position `index` of `this`.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">substr(index:[Int](http://api.haxe.org/Int.html)<span></span>, len:[Int](http://api.haxe.org/Int.html)<span></span>) : [mint.core.unifill.Utf16](../../../../api/mint/core/unifill/Utf16.html)</code><br/><span class="small_desc_flat">Returns `len` code units of `this`, starting at position pos.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">validate() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Validates `this` Utf16 string.
