...
<h1>LuxeMintRender</h1>
<small>`mint.render.luxe.LuxeMintRender`</small>



<hr/>

`class`extends <code><span>mint.render.Rendering</span></code><br/><span class="meta">
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">options : [luxe.options.RenderProperties](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="get"><a class="lift" href="#get">get</a></a><div class="clear"></div>
            <code class="signature apipage">get&lt;T&gt;, T1&gt;(type:[Class](#)&lt;[get.T](#)&gt;<span></span>, control:[get.T](#)<span></span>) : [get.T1](#)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_options:[luxe.options.RenderProperties](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
