...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="real_y"><a class="lift" href="#real_y">real\_y</a></a><div class="clear"></div>
                <code class="signature apipage">real\_y : [Float](http://api.haxe.org/Float.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="real_x"><a class="lift" href="#real_x">real\_x</a></a><div class="clear"></div>
                <code class="signature apipage">real\_x : [Float](http://api.haxe.org/Float.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="real_w"><a class="lift" href="#real_w">real\_w</a></a><div class="clear"></div>
                <code class="signature apipage">real\_w : [Float](http://api.haxe.org/Float.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="real_h"><a class="lift" href="#real_h">real\_h</a></a><div class="clear"></div>
                <code class="signature apipage">real\_h : [Float](http://api.haxe.org/Float.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
