...
class MICanvasRenderer {
    ...
    public function translate( _control:MICanvas, _x:Float, _y:Float, ?_offset:Bool = false ) { } //translate
...
class MILabelRenderer {
    ...
    public function translate( _control:MILabel, _x:Float, _y:Float, ?_offset:Bool = false ) { } //translate
...
class MIButtonRenderer {
    ...
    public function translate( _control:MIButton, _x:Float, _y:Float, ?_offset:Bool = false ) { } //translate
...
class MIListRenderer {
    ...
    public function translate( _control:MIList, _x:Float, _y:Float, ?_offset:Bool = false ) { } //translate
...
class MIImageRenderer {
    ...
    public function translate( _control:MIImage, _x:Float, _y:Float, ?_offset:Bool = false ) { } //translate
...
class MIWindowRenderer {
    ...
    public function translate( _control:MIWindow, _x:Float, _y:Float, ?_offset:Bool = false ) { } //translate
...
class MIScrollAreaRenderer {
    ...
    public function translate( _control:MIScrollArea, _x:Float, _y:Float, ?_offset:Bool = false ) { } //translate
...
class MIDropdownRenderer {
    ...
    public function translate( _control:MIDropdown, _x:Float, _y:Float, ?_offset:Bool = false ) { } //translate
...
class MIPanelRenderer {
    ...
    public function translate( _control:MIPanel, _x:Float, _y:Float, ?_offset:Bool = false ) { } //translate
...
class MICheckboxRenderer {
    ...
    public function translate( _control:MICheckbox, _x:Float, _y:Float, ?_offset:Bool = false ) { } //translate
