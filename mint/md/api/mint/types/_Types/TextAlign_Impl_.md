...
<h1>TextAlign_Impl_</h1>
<small>`mint.types._Types.TextAlign_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="bottom"><a class="lift" href="#bottom">bottom</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">bottom : [mint.types.TextAlign](../../../../api/mint/types/TextAlign.html)</code><br/></span>
            <span class="small_desc_flat">(vertical) Bottom aligned</span><br/><span class="member apipage">
                <a name="center"><a class="lift" href="#center">center</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">center : [mint.types.TextAlign](../../../../api/mint/types/TextAlign.html)</code><br/></span>
            <span class="small_desc_flat">(horizontal/vertical) Center aligned</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">left : [mint.types.TextAlign](../../../../api/mint/types/TextAlign.html)</code><br/></span>
            <span class="small_desc_flat">(horizontal) Left aligned</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">right : [mint.types.TextAlign](../../../../api/mint/types/TextAlign.html)</code><br/></span>
            <span class="small_desc_flat">(horizontal) Right aligned</span><br/><span class="member apipage">
                <a name="top"><a class="lift" href="#top">top</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">top : [mint.types.TextAlign](../../../../api/mint/types/TextAlign.html)</code><br/></span>
            <span class="small_desc_flat">(vertical) Top aligned</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">unknown : [mint.types.TextAlign](../../../../api/mint/types/TextAlign.html)</code><br/></span>
            <span class="small_desc_flat">An unknown alignment</span><br/>
