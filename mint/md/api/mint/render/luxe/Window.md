...
<h1>Window</h1>
<small>`mint.render.luxe.Window`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">border : [phoenix.geometry.RectangleGeometry](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="collapse"><a class="lift" href="#collapse">collapse</a></a><div class="clear"></div>
                <code class="signature apipage">collapse : [phoenix.geometry.Geometry](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="color_border"><a class="lift" href="#color_border">color\_border</a></a><div class="clear"></div>
                <code class="signature apipage">color\_border : [luxe.Color](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="color_collapse"><a class="lift" href="#color_collapse">color\_collapse</a></a><div class="clear"></div>
                <code class="signature apipage">color\_collapse : [luxe.Color](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="color_titlebar"><a class="lift" href="#color_titlebar">color\_titlebar</a></a><div class="clear"></div>
                <code class="signature apipage">color\_titlebar : [luxe.Color](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="top"><a class="lift" href="#top">top</a></a><div class="clear"></div>
                <code class="signature apipage">top : [phoenix.geometry.QuadGeometry](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="visual"><a class="lift" href="#visual">visual</a></a><div class="clear"></div>
                <code class="signature apipage">visual : [phoenix.geometry.QuadGeometry](#)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="window"><a class="lift" href="#window">window</a></a><div class="clear"></div>
                <code class="signature apipage">window : [mint.Window](../../../../api/mint/Window.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_render:[mint.render.luxe.LuxeMintRender](../../../../api/mint/render/luxe/LuxeMintRender.html)<span></span>, \_control:[mint.Window](../../../../api/mint/Window.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
