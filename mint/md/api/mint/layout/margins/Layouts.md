...
<h1>Layouts</h1>
<small>`mint.layout.margins.Layouts`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="sizers"><a class="lift" href="#sizers">sizers</a></a><div class="clear"></div>
                <code class="signature apipage">sizers : [Array](http://api.haxe.org/Array.html)&lt;[mint.layout.margins._Margins.Sizer](../../../../api/mint/layout/margins/_Margins/Sizer.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="margins"><a class="lift" href="#margins">margins</a></a><div class="clear"></div>
                <code class="signature apipage">margins : [Array](http://api.haxe.org/Array.html)&lt;[mint.layout.margins._Margins.Margin](../../../../api/mint/layout/margins/_Margins/Margin.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="anchors"><a class="lift" href="#anchors">anchors</a></a><div class="clear"></div>
                <code class="signature apipage">anchors : [Array](http://api.haxe.org/Array.html)&lt;[mint.layout.margins._Margins.Anchor](../../../../api/mint/layout/margins/_Margins/Anchor.html)&gt;</code><br/></span>
