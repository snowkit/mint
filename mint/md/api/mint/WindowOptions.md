...
<h1>WindowOptions</h1>
<small>`mint.WindowOptions`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The title of the window to display as a label</span><br/><span class="member apipage">
                <a name="text_size"><a class="lift" href="#text_size">text\_size</a></a><div class="clear"></div>
                <code class="signature apipage">text\_size : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The text size for the title text</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">Whether or not the window can be resized by it's bottom right corner</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The control name</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">moveable : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Whether or not the window can be moved by it's title bar</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The control height</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">focusable : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Whether or not the window is focusable (bring to front on click)</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The control depth. Usually set internally</span><br/><span class="member apipage">
                <a name="collapsible"><a class="lift" href="#collapsible">collapsible</a></a><div class="clear"></div>
                <code class="signature apipage">collapsible : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Whether or not the window is collapsible</span><br/><span class="member apipage">
                <a name="closable"><a class="lift" href="#closable">closable</a></a><div class="clear"></div>
                <code class="signature apipage">closable : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Whether or not the window can be closed by the top right corner</span><br/>
