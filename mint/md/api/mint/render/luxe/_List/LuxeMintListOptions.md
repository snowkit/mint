...
<h1>LuxeMintListOptions</h1>
<small>`mint.render.luxe._List.LuxeMintListOptions`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="color_selected"><a class="lift" href="#color_selected">color\_selected</a></a><div class="clear"></div>
                <code class="signature apipage">color\_selected : [luxe.Color](#)</code><br/></span>
