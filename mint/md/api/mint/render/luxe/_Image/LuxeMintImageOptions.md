...
<h1>LuxeMintImageOptions</h1>
<small>`mint.render.luxe._Image.LuxeMintImageOptions`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">uv : [Null](http://api.haxe.org/Null.html)&lt;[luxe.Rectangle](#)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="sizing"><a class="lift" href="#sizing">sizing</a></a><div class="clear"></div>
                <code class="signature apipage">sizing : [Null](http://api.haxe.org/Null.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="color"><a class="lift" href="#color">color</a></a><div class="clear"></div>
                <code class="signature apipage">color : [Null](http://api.haxe.org/Null.html)&lt;[luxe.Color](#)&gt;</code><br/></span>
