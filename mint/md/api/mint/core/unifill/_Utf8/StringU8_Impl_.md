...
<small>`mint.core.unifill._Utf8.StringU8_Impl_`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">codeUnitAt(this:[String](http://api.haxe.org/String.html)<span></span>, index:[Int](http://api.haxe.org/Int.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">fromBytes(b:[haxe.io.Bytes](http://api.haxe.org/haxe/io/Bytes.html)<span></span>) : [mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">fromString(s:[String](http://api.haxe.org/String.html)<span></span>) : [mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="ofBytes"><a class="lift" href="#ofBytes">ofBytes</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">ofBytes(b:[haxe.io.Bytes](http://api.haxe.org/haxe/io/Bytes.html)<span></span>) : [mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">substr(this:[String](http://api.haxe.org/String.html)<span></span>, index:[Int](http://api.haxe.org/Int.html)<span></span>, len:[Int](http://api.haxe.org/Int.html)<span></span>) : [mint.core.unifill._Utf8.StringU8](../../../../../api/mint/core/unifill/_Utf8/StringU8.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">toBytes(this:[String](http://api.haxe.org/String.html)<span></span>) : [haxe.io.Bytes](http://api.haxe.org/haxe/io/Bytes.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">toString(this:[String](http://api.haxe.org/String.html)<span></span>) : [String](http://api.haxe.org/String.html)</code><br/><span class="small_desc_flat"></span>
