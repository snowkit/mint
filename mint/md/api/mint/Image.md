...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">Emitted whenever the path/id is changed.
            `function(new_path:String)`</span><br/>
...
<h3>Properties</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The current image path/id. Read/Write</span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_options:[mint.ImageOptions](../../api/mint/ImageOptions.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
