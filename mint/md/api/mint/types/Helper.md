...
<span class="method apipage">
            <a name="in_rect"><a class="lift" href="#in_rect">in\_rect</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">in\_rect(x:[Float](http://api.haxe.org/Float.html)<span></span>, y:[Float](http://api.haxe.org/Float.html)<span></span>, rx:[Float](http://api.haxe.org/Float.html)<span></span>, ry:[Float](http://api.haxe.org/Float.html)<span></span>, rw:[Float](http://api.haxe.org/Float.html)<span></span>, rh:[Float](http://api.haxe.org/Float.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat"></span>
