...
<h1>UtfIter</h1>
<small>`mint.core.unifill.UtfIter`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="endIndex"><a class="lift" href="#endIndex">endIndex</a></a><div class="clear"></div>
                <code class="signature apipage">endIndex : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="string"><a class="lift" href="#string">string</a></a><div class="clear"></div>
                <code class="signature apipage">string : [mint.core.unifill.UtfIter.S](../../../../api/mint/core/unifill/UtfIter/S.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="hasNext"><a class="lift" href="#hasNext">hasNext</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">hasNext() : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">new(s:[mint.core.unifill.UtfIter.S](../../../../api/mint/core/unifill/UtfIter/S.html)<span></span>, beginIndex:[Int](http://api.haxe.org/Int.html)<span></span>, endIndex:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="next"><a class="lift" href="#next">next</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">next() : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>
