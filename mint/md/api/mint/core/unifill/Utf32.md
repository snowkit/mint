...
<h1>Utf32</h1>
<small>`mint.core.unifill.Utf32`</small>

Utf32 provides a UTF-32-encoded string.

<hr/>

`class`<br/>implements <code><span>mint.core.unifill.Utf</span></code><br/><span class="meta">
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">charAt(index:[Int](http://api.haxe.org/Int.html)<span></span>) : [mint.core.unifill.Utf32](../../../../api/mint/core/unifill/Utf32.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="codePointAt"><a class="lift" href="#codePointAt">codePointAt</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">codePointAt(index:[Int](http://api.haxe.org/Int.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">codePointWidthAt(index:[Int](http://api.haxe.org/Int.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">codePointWidthBefore(index:[Int](http://api.haxe.org/Int.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">codeUnitAt(index:[Int](http://api.haxe.org/Int.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">fromArray(a:[Array](http://api.haxe.org/Array.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;<span></span>) : [mint.core.unifill.Utf32](../../../../api/mint/core/unifill/Utf32.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">fromCodePoint(codePoint:[Int](http://api.haxe.org/Int.html)<span></span>) : [mint.core.unifill.Utf32](../../../../api/mint/core/unifill/Utf32.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">fromCodePoints(codePoints:[Iterable](#)&lt;[Int](http://api.haxe.org/Int.html)&gt;<span></span>) : [mint.core.unifill.Utf32](../../../../api/mint/core/unifill/Utf32.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">fromString(string:[String](http://api.haxe.org/String.html)<span></span>) : [mint.core.unifill.Utf32](../../../../api/mint/core/unifill/Utf32.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="toArray"><a class="lift" href="#toArray">toArray</a></a><span class="inline-block static">inline</span><div class="clear"></div>
            <code class="signature apipage">toArray() : [Array](http://api.haxe.org/Array.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">validate() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
