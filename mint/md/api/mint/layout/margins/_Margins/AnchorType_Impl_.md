...
<h1>AnchorType_Impl_</h1>
<small>`mint.layout.margins._Margins.AnchorType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">bottom : [mint.layout.margins.AnchorType](../../../../../api/mint/layout/margins/AnchorType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="center_x"><a class="lift" href="#center_x">center\_x</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">center\_x : [mint.layout.margins.AnchorType](../../../../../api/mint/layout/margins/AnchorType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="center_y"><a class="lift" href="#center_y">center\_y</a></a><span class="inline-block static">inline</span><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">center\_y : [mint.layout.margins.AnchorType](../../../../../api/mint/layout/margins/AnchorType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">left : [mint.layout.margins.AnchorType](../../../../../api/mint/layout/margins/AnchorType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">right : [mint.layout.margins.AnchorType](../../../../../api/mint/layout/margins/AnchorType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">top : [mint.layout.margins.AnchorType](../../../../../api/mint/layout/margins/AnchorType.html)</code><br/></span>
