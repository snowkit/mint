...
<h1>Margins</h1>
<small>`mint.layout.margins.Margins`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="anchor"><a class="lift" href="#anchor">anchor</a></a><div class="clear"></div>
            <code class="signature apipage">anchor(self:[mint.Control](../../../../api/mint/Control.html)<span></span>, other:[mint.Control](../../../../api/mint/Control.html)<span></span>, self\_anchor:[mint.layout.margins.AnchorType](../../../../api/mint/layout/margins/AnchorType.html)<span></span>, other\_anchor:[mint.layout.margins.AnchorType](../../../../api/mint/layout/margins/AnchorType.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="margin"><a class="lift" href="#margin">margin</a></a><div class="clear"></div>
            <code class="signature apipage">margin(self:[mint.Control](../../../../api/mint/Control.html)<span></span>, other:[mint.Control](../../../../api/mint/Control.html)<span></span>, target:[mint.layout.margins.MarginTarget](../../../../api/mint/layout/margins/MarginTarget.html)<span></span>, type:[mint.layout.margins.MarginType](../../../../api/mint/layout/margins/MarginType.html)<span></span>, value:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">size(self:[mint.Control](../../../../api/mint/Control.html)<span></span>, other:[mint.Control](../../../../api/mint/Control.html)<span></span>, target:[mint.layout.margins.SizeTarget](../../../../api/mint/layout/margins/SizeTarget.html)<span></span>, value:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
