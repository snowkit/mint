...
<h1>Anchor</h1>
<small>`mint.layout.margins._Margins.Anchor`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="self_anchor"><a class="lift" href="#self_anchor">self\_anchor</a></a><div class="clear"></div>
                <code class="signature apipage">self\_anchor : [mint.layout.margins.AnchorType](../../../../../api/mint/layout/margins/AnchorType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="self"><a class="lift" href="#self">self</a></a><div class="clear"></div>
                <code class="signature apipage">self : [mint.Control](../../../../../api/mint/Control.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="other_anchor"><a class="lift" href="#other_anchor">other\_anchor</a></a><div class="clear"></div>
                <code class="signature apipage">other\_anchor : [mint.layout.margins.AnchorType](../../../../../api/mint/layout/margins/AnchorType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="other"><a class="lift" href="#other">other</a></a><div class="clear"></div>
                <code class="signature apipage">other : [mint.Control](../../../../../api/mint/Control.html)</code><br/></span>
